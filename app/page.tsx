      ...
      <section id="welcome" className="py-24 bg-white">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          ...
          <p className="text-lg text-black leading-relaxed italic mb-8">
            "Welcome to EASTDOC STUDIOS, where refinement meets bespoke elegance. Step into a realm
            of timeless sophistication, curated exclusively for those who seek unparalleled excellence.
            Embrace the art of distinction as we invite you to indulge in a realm where luxury knows no bounds."
          </p>
