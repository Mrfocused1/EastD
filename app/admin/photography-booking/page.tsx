...
export default function PhotographyBookingFormAdmin() {
  ...
  async function saveFormConfig() {
    ...
    try {
      ...
      if (fieldsError || titleError) {
        console.error("Error saving form config:", fieldsError || titleError);
        setSaveStatus("error");
      } else {
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <h1 className="text-4xl font-light text-black">Photography Booking Form</h1>
          </div>
          <button
      ...
      >
        <div className="bg-white border border-black/10 p-6">
          ...
          <input
            ...
            placeholder="Photography Booking Request"
          />
        </div>
      </motion.div>
